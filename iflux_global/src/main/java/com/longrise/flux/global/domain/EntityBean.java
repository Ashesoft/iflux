package com.longrise.flux.global.domain;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.longrise.flux.global.excutor.JDBCExcutor;
...
public class EntityBean extends ConcurrentHashMap<String, Object> implements Serializable {
    ...
    public boolean update() {
        String beanName = Optional.ofNullable(this.getString("beanname")).orElseThrow(() -> new RuntimeException("没有绑定表名"));
        ...
        id = Optional.ofNullable(id).orElseThrow(() -> new RuntimeException("没有绑定主键"));
    ...
    public boolean insert() {
        String beanName = Optional.ofNullable(this.getString("beanname")).orElseThrow(() -> new RuntimeException("没有绑定beanname"));
        this.remove("beanname");
