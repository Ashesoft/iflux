package com.longrise.flux.global.excutor;

import com.longrise.flux.global.action.ResultSetAction;
...
public class JDBCExcutor implements ApplicationContextAware {
    ...
    public String[] getPriKey(String tableName){
        try{
            ...
            if(priKeys.isEmpty()){
                throw new RuntimeException(String.format("[%s]数据表没有主键", tableName));
            }
